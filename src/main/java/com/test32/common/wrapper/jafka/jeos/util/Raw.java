package com.test32.common.wrapper.jafka.jeos.util;
...
public class Raw {
    ...
    public Raw packCustomSymbol(String v) {
    ...
    public Raw packHexString(String v) {
        byte[] bytes = Hex.toBytes(v);
        packVarint32(bytes.length);
        s.append(bytes);
        return this;
    }

    public Raw packByteArray(byte[] bytes) {
        packVarint32(bytes.length);
        s.append(bytes);
        return this;
    }
