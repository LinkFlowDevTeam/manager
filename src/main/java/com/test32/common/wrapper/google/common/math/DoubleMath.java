...
public final class DoubleMath {
   ...
   */
  @GwtIncompatible
  // #isMathematicalInteger, com.test32.common.wrapper.google.common.math.DoubleUtils
   ...
   *     </ul>
   */
  // #roundIntermediate, java.lang.Math.getExponent, com.test32.common.wrapper.google.common.math.DoubleUtils
  @GwtIncompatible
   ...
   * {@code k}.
   */
  @GwtIncompatible // com.test32.common.wrapper.google.common.math.DoubleUtils
   ...
   */
  @GwtIncompatible
  // java.lang.Math.getExponent, com.test32.common.wrapper.google.common.math.DoubleUtils
  ...
  public static boolean isMathematicalInteger(double x) {
    return DoubleUtils.isFinite(x)
        && (x == 0.0
            || DoubleUtils.SIGNIFICAND_BITS - Long.numberOfTrailingZeros(DoubleUtils.getSignificand(x)) <= getExponent(x));
  }
  ...
  public static int fuzzyCompare(double a, double b, double tolerance) {
    if (fuzzyEquals(a, b, tolerance)) {
      ...
      return com.test32.common.wrapper.google.common.primitives.Booleans.compare(Double.isNaN(a), Double.isNaN(b));
    }
  }
   ...
   */
  @Deprecated
  // com.test32.common.wrapper.google.common.math.DoubleUtils
  @GwtIncompatible
