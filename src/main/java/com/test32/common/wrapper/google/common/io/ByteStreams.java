...
public final class ByteStreams {
  ...
  private static byte[] toByteArrayInternal(InputStream in, Deque<byte[]> bufs, int totalLen)
    ...
    for (int bufSize = BUFFER_SIZE;
        ...
        bufSize = com.test32.common.wrapper.google.common.math.IntMath.saturatedMultiply(bufSize, 2)) {
...
//  }
   ...
   * @since 14.0 (since 1.0 as com.test32.common.wrapper.google.common.io.LimitInputStream)
   */
  @Beta
...
//  }
   ...
   * actually remain in the file, something that it {@linkplain FileInputStream#skip(long)
